...
- **MANDATORY: ALWAYS run `just check` for every change and report the result. Do not skip it. Do not assume it passes. If it fails, stop and fix it before proceeding.**
